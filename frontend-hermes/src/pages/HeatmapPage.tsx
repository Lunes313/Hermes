...
const COMUNAS_COORDS: Record<string, [number, number]> = {
  "Popular": [6.2990, -75.5450],
  "Santa Cruz": [6.2950, -75.5550],
  "Manrique": [6.2800, -75.5500],
  "Aranjuez": [6.2750, -75.5600],
  "Castilla": [6.2850, -75.5800],
  "Doce de Octubre": [6.3000, -75.5850],
  "Robledo": [6.2750, -75.5900],
  "Villa Hermosa": [6.2550, -75.5500],
  "Buenos Aires": [6.2400, -75.5500],
  "La Candelaria": [6.2450, -75.5650],
  "Laureles": [6.2450, -75.5900],
  "La América": [6.2550, -75.6050],
  "San Javier": [6.2500, -75.6150],
  "Poblado": [6.2100, -75.5700],
  "Guayabal": [6.2150, -75.5850],
  "Belén": [6.2250, -75.6000],
